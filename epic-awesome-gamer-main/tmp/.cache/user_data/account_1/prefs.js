...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1748777197);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1748777197);
user_pref("app.update.lastUpdateTime.region-update-timer", 1748777197);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1748777197);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1748777227);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1748777197);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{bbdea717-df6e-4834-a202-8802a056ef97}");
...
user_pref("browser.startup.lastColdStartupCheck", 1748777630);
...
user_pref("extensions.formautofill.creditCards.reauth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECH+boXue+yfmBAjMc00fI1pl7g==");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"20ece26e-bd4f-4019-9c2a-8b09c97974e0\",\"pictureinpicture@mozilla.org\":\"337e4020-2149-4157-b4a6-a22a30c4091d\",\"screenshots@mozilla.org\":\"6c3f095c-e752-4174-9a86-03718cd2c2ba\",\"webcompat@mozilla.org\":\"8d7146cf-b05f-4a19-9b97-d4e429ca0200\",\"firefox-compact-dark@mozilla.org\":\"3141e288-0144-4c2d-abb9-7152be118041\",\"addons-search-detection@mozilla.com\":\"86d97dc5-bbae-4727-acf5-cb863f8672d5\",\"uBlock0@raymondhill.net\":\"c3a18954-18ec-4f97-bbb6-f48b950be9bd\"}");
...
user_pref("media.gmp-manager.lastCheck", 1748777218);
user_pref("media.gmp-manager.lastEmptyCheck", 1748777218);
user_pref("media.gmp.storage.version.observed", 1);
user_pref("media.hardware-video-decoding.failed", false);
user_pref("media.videocontrols.picture-in-picture.video-toggle.first-seen-secs", 1748777768);
...
user_pref("signon.management.page.os-auth.optout", "MDIEEPgAAAAAAAAAAAAAAAAAAAEwFAYIKoZIhvcNAwcECMRWka346Yh0BAhJGPq8TjWI4A==");
user_pref("toolkit.startup.last_success", 1748777628);
