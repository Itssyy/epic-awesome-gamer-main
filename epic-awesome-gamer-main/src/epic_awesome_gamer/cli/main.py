...
def collect(
    ...
    async def startup_epic_awesome_gamer(page: Page):
        ...
        solver_config = AgentConfig(
            ...
            CHALLENGE_CLASSIFIER_MODEL='gemini-2.5-flash-preview-05-20',  # Change to specified flash model
            IMAGE_CLASSIFIER_MODEL='gemini-2.5-flash-preview-05-20',  # Change to specified flash model
            SPATIAL_POINT_REASONER_MODEL='gemini-2.5-flash-preview-05-20',  # Change to specified flash model
            SPATIAL_PATH_REASONER_MODEL='gemini-2.5-flash-preview-05-20',  # Change to specified flash model
        )
